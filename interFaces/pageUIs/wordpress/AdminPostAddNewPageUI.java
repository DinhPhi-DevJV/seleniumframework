...
public class AdminPostAddNewPageUI {
	...
	public static final String PUBLISH_OR_UPDATE_BUTTON="css=button.editor-post-publish-panel__toggle";
	public static final String PUBLISH_BUTTON_MENU ="css=button.editor-post-publish-button";
