 ...
 * import java.util.Map; import org.testng.IReporter; import
 ...
 */
/*
 * public class ExtentReportListenerV2 implements IReporter { // nếu không cần
 * chụp hình thì cấu hình như thế này.
 * 
 * private ExtentReports extent; private ExtentTest test;
 * 
 * public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites,
 * String outputDirectory) { extent = new
 * ExtentReports(System.getProperty("user.dir") + "/ExtentV2/ExtentReport.html",
 * true); for (ISuite suite : suites) { Map<String, ISuiteResult> result =
 * suite.getResults();
 * 
