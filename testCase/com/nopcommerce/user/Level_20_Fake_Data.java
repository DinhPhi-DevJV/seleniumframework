...
public class Level_20_Fake_Data extends BaseTest {
	...
	public void beforeClass(String browserName) {
		...
		emailAdress = dataHelper.getEamilAddress();
	...
	public void User_01_Register(Method method) {
		ExtentTestManager.startTest(method.getName(), "User01_Register");
		ExtentTestManager.getTest().log(Status.INFO,"Register - Step 1: Navigate to 'Rigisster' page");
		...
		ExtentTestManager.getTest().log(Status.INFO,"Register - Step 2: Enter to First name textbox with value is '"+ firstName+"'");
		...
		ExtentTestManager.getTest().log(Status.INFO,"Register - Step 3: Enter to Last name textbox with value is '"+ lastName+"'");
		log.info("Register - Step 3: Enter to Last name textbox with value is '"+ lastName+"'");
	...
	public void User_02_Login(Method method) {
		ExtentTestManager.startTest(method.getName(), "User02_Login");
