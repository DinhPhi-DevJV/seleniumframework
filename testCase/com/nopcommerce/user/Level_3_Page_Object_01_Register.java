...
public class Level_3_Page_Object_01_Register{
	WebDriver driver;
	String emailAdress;
	// Declare
	...
	public void  Register_05_PassWord_Less_Than_6_Chars() {
		...
		Assert.assertEquals(registerPageObject.getErrorMessageAtPaswordTextBox(),"Password must meet the following rules:\nmust have at least 6 characters");
	}
